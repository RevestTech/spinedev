...
> **Superseded as operational truth (2026-04-23).** This file is a **historical** snapshot. It contains statements that are **no longer true** of the codebase (e.g. it claims QAISO is not registered; current `tron/services/audit_executor.py` registers six ISO agents including QAISO, Compliance, and Documentation). For **what shipped**, use **`docs/project/BRD.md`** and **`docs/project/TRD.md`**; for **open backlog**, **`docs/project/MASTER_PROPOSAL_TODO.md`**; for evidence rows, **`docs/project/REQUIREMENTS_TRACEABILITY.md`**; for ops hardening, **`docs/project/HARDENING_REVIEW_TODO.md`**. Do not use this document alone to judge the product.
