...
> **Archived (2026-05).** Point-in-time checklist; some bullets are **stale** (e.g. WebSocket query-string auth, CORS examples). For current production-readiness work use **`docs/project/HARDENING_REVIEW_TODO.md`**, **`docs/security/TLS_RUNBOOK.md`**, and **`docs/security/SANDBOX_THREAT_MODEL.md`**. Full doc map: **`docs/BLUEPRINT.md`**.
