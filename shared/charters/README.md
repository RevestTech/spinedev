...
retired v1/v2 `lib/role-prompts/` tree (removed post-Wave 6 charter migration).
...
Wave 3 (housekeeping): all project-role charters now live in this directory
per #7. The runtime loader reads `shared/charters/<role>.md` exclusively;
the retired v1/v2 `lib/role-prompts/` tree was removed after Wave 6.

### Retired v2 roles (no v3 charter)
